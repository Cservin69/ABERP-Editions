...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_inspection_plans,
            commands::create_inspection_plan,
            commands::update_inspection_plan,
            commands::archive_inspection_plan,
            commands::record_qc_inspection,
            commands::list_qc_inspections,
            commands::qc_stale_calibration,
            commands::set_qc_calibration_window,
            // ADR-0199 — QC/AS9102 FAIR + Certificate-of-Conformance reports.
            commands::list_qc_reports,
            commands::draft_qc_report,
            commands::get_qc_report,
            commands::issue_qc_report,
            commands::void_qc_report,
            commands::list_dispatch_qc_reports,
            commands::set_partner_qc_report_template,
            commands::download_qc_report_pdf,
            commands::list_purchase_orders,
            commands::create_purchase_order,
            commands::get_purchase_order,
            commands::transition_purchase_order,
